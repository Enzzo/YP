...
namespace tc {
	...
	void TransportCatalogue::SetDistanceBetweenStops(std::shared_ptr<Stop> from, std::shared_ptr<Stop> to, size_t distance) {
		distance_between_stops_[make_pair(from, to)] = distance;
	}
