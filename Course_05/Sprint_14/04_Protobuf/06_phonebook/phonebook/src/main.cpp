...
void TestCustomFindNameByPrefix() {
    PhoneBook book({
        {"jjj"s, std::nullopt, {"jk"}},
        {"jjjja"s, std::nullopt, {"ja"}},
        {"jjj aaa"s, std::nullopt, {"jc"}},
        {"aaa"s, std::nullopt, {"a"}},
        {"bbb"s, std::nullopt, {"b"}},
        {"lll"s, std::nullopt, {"l"}},
        {"ccc"s, std::nullopt, {"c"}},
    ...
    //book.FindByNamePrefix("");
    //book.FindByNamePrefix(""s);
    //book.FindByNamePrefix(""sv);
    //book.FindByNamePrefix("    ");
    book.FindByNamePrefix("jjj");
    book.FindByNamePrefix("ccc");
